        ...
        <div class="conatiner">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-7">
                    <form class="card p-2 margin" methos="post" action="index.php">
                ...
                <div class="col-md-10 col-lg-8 col-xl-7">
                    <table class="table mt-4">
                        ...
                        <tbody>
                            ...
                            <td><a href="http://localhost/url/u?id=<?php echo $row->id;?>" target="_blank">"http://localhost/url/u?id=<?php echo $row->id;?><a></td>
